...
COS_API_KEY_ID = "xVWVt8tjo5lL5eY-jii6RAZu4IAfMrRQY2uaD0_-9LZj" # eg "W00YixxxxxxxxxxMB-odB-2ySfTrFBIQQWanc--P3byk"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/37641ef4661f44a7bfab12af5b4ba6fe::serviceid:ServiceId-dd1803b4-6727-46a8-b09c-1e921e8211c6"
...
@app.route('/')
def index():
    files = get_bucket_contents('harisudhan-bucket1')
