...
COS_API_KEY_ID = "x6L6XWyU_Y68Bb25GIE5YIv8wXCWy7iI28rUlKhLEfI8" # eg "W00YixxxxxxxxxxMB-odB-2ySfTrFBIQQWanc--P3byk"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/c2c57fb28ea549c98987d910a80e8b45::serviceid:ServiceId-dcfc62f4-6501-4c35-92be-df31711dbc1d"
...
@app.route('/')
def index():
    files = get_bucket_contents('jhananijayaram-objectstorage1')
